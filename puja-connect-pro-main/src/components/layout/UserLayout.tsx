...
import { Home, Search, Calendar, User, LogOut, BookOpen } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { Button } from '@/components/ui/button';

const navItems = [
  { label: 'Dashboard', icon: Home, path: '/user' },
  { label: 'Browse Pujas', icon: BookOpen, path: '/user/pujas' },
  { label: 'Find Pandits', icon: Search, path: '/user/pandits' },
  { label: 'My Bookings', icon: Calendar, path: '/user/bookings' },
